...
const sections = [
  {
    heading: "Who we are",
    paragraphs: [
      "This Refund Policy applies to purchases made through CivicSign, operated by CivicBot LTD (registered in England and Wales, registered office: 71-75 Shelton Street, Covent Garden, London WC2H 9JQ, United Kingdom).",
      "It should be read together with our Terms & Conditions and Privacy Policy. Where this policy offers you more favourable rights than the law requires, we will honour this policy.",
    ],
  },
  {
    heading: "Scope",
  ...
  },
  {
    heading: "Free plan",
    paragraphs: [
      "The Free plan does not involve payment. No refund applies. Your document allowance resets automatically on each monthly anniversary of your account registration date (see “Billing cycles” below).",
    ],
  },
  {
  ...
  },
  {
    ...
    list: [
      ...
      "A verified billing error (e.g. charged twice for the same plan).",
  ...
  },
  {
    ...
    paragraphs: [
      "Monthly document limits reset on the anniversary of your account registration date, not on the 1st of the calendar month. For example, if you registered on 8 March, your allowance refreshes on the 8th of each month.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "We will email you at the address on your CivicSign account when a refund has been initiated. For subscription refunds processed by our team, you may also receive a notification from Stripe.",
    ],
  },
  {
    heading: "How to request a refund",
    paragraphs: [
      "To request a refund, email info@civicbot.co.uk from the email address registered on your account and include:",
    ],
    list: [
  ...
  },
  {
    ...
    paragraphs: [
      "We aim to acknowledge refund requests within 2 business days and to provide a decision within 10 business days. Complex cases (e.g. enterprise contracts or disputed usage) may take longer; we will keep you informed.",
    ],
  },
  {
    heading: "Chargebacks",
    paragraphs: [
      "If you dispute a charge with your bank or card issuer without contacting us first, we may suspend your account while the dispute is investigated. We encourage you to reach out to info@civicbot.co.uk so we can resolve issues quickly.",
    ],
  },
  {
  ...
  },
  {
    heading: "Contact",
    paragraphs: [
      "Billing, refunds & general enquiries: info@civicbot.co.uk",
      "You can also reach us via our Contact page.",
      "You may also write to: CivicBot LTD, 71-75 Shelton Street, Covent Garden, London WC2H 9JQ, United Kingdom.",
    ],
  },
];
