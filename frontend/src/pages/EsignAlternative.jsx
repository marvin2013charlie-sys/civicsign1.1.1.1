...
const POINTS = [
  {
    ...
    body: "CivicSign is UK-owned and UK-hosted e-signature software. If you are shortlisting an eSign alternative because data residency and UK GDPR posture matter, start here — with hosting and ownership you can explain to compliance alongside other UK vendors.",
  },
  {
    ...
    body: (
      <>
        ...
        A real free tier to evaluate — not only a short trial. eSign typically publishes seat plans with envelope allowances; check their site for current pricing, then compare honesty and fit for your volume.{" "}
...
const FAQS = [
  [
    "Is CivicSign an eSign alternative?",
    "Yes. CivicSign covers the core UK send-and-sign workflow teams use eSign for — with UK hosting, published GBP pricing, a real free tier, Manage PDF on paid plans, and no signer accounts.",
  ],
  [
    "How does pricing compare to eSign?",
    `${formatFreePlanSignupPitch()} Pro is about ${formatProMonthlyShort()} per user with Manage PDF included. eSign typically publishes seat plans with monthly envelope allowances and a free trial rather than an ongoing free plan — check their site for current pricing before you buy, then shortlist on honesty and fit.`,
  ],
  [
    "Where is CivicSign data hosted?",
    "CivicSign is UK-owned and UK-hosted. Personal data is processed under UK GDPR and the Data Protection Act 2018 — a clear fit for UK buyers comparing eSign and other UK e-signature options.",
  ],
  [
...
const TABLE_ROWS = [
  ...
  },
  {
    ...
    right: "Typically published seat plans with envelope allowances — check their site for current pricing",
  },
  {
  ...
  },
  {
    ...
    right: "Teams who prefer eSign's feature set / public-sector credentials and already use eSign",
  },
];

export default function EsignAlternative() {
  return (
    <MarketingMoneyPage
      testId="esign-alternative-page"
      eyebrow="eSign alternative UK"
      headline={
        <>
          A clearer eSign alternative for UK teams
          <span style={{ color: "var(--c-accent)" }}>.</span>
        </>
      }
      subhead="Comparing eSign to CivicSign? CivicSign is UK e-signature software with UK hosting, honest GBP pricing, Manage PDF 2-in-1 on paid plans, a free tier to evaluate, and no signer accounts — built for UK GDPR and UK eIDAS without the enterprise maze."
      points={POINTS}
      comparison={{
      ...
      table={{
        eyebrow: "CivicSign vs eSign",
        title: "UK buyer checklist",
        subtitle:
          "Fair shortlist criteria — hosting, pricing honesty, free-tier clarity, PDF workflow, signer friction and UK law alignment. Confirm eSign details on their current site before you buy.",
        leftLabel: "CivicSign",
        rightLabel: "eSign (typical)",
        rows: TABLE_ROWS,
        footnote: (
          <>
