...
export default function Healthcare() {
  return (
    <SolutionPageLayout
      ...
      headline={<>Consent forms & care plans, <span style={{ color: "var(--c-primary)" }}>signed without paper trail risks.</span></>}
      subhead="Built for UK GP practices, private clinics, dentists and CQC-registered care providers. Capture patient consent, care-plan signatures and staff acknowledgements — UK GDPR strict by default, NHS-DSPT friendly."
      heroImage={{
        src: "https://images.unsplash.com/photo-1576091160550-2173dba999ef",
        alt: "UK clinician reviewing patient consent on tablet",
      }}
      stats={[
        { value: "DSPT", label: "Designed for NHS Data Security toolkit alignment" },
      ...
      why={[
        ...
        { icon: ShieldCheck, title: "UK GDPR · special-category data ready", body: "Patient data is processed under UK GDPR Article 9 lawful bases. Role-based access separates admin from clinical staff." },
        { icon: CheckCircle2, title: "CQC & GMC aligned", body: "Audit trail captures the GMC consent process: information given, time to consider, signature and any questions raised." },
      ...
      docs={[
        ...
        { icon: ClipboardList, title: "Care & support plans (CQC)", body: "Service user and family signatures on care plans, capacity assessments and DoLS notifications — CQC inspection-ready." },
        { icon: UserCheck,     title: "Patient registration & GDPR consent", body: "New-patient registration with privacy notice acknowledgement and marketing-preference fields, all in one signing flow." },
        { icon: ScrollText,    title: "Safeguarding & incident records", body: "Staff sign-off on safeguarding referrals and incident forms — tamper-evident and instantly retrievable for inspection." },
        { icon: FileSignature, title: "Staff DBS & policy attestations", body: "Capture annual DBS declarations, code of conduct sign-off and training acknowledgements in bulk." },
