...
export const CookieBanner = () => {
  ...
  const accept = (val) => { localStorage.setItem("cs_cookie_consent", val); setShow(false); };
  if (!show) return null;
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 p-3 sm:p-4" data-testid="cookie-banner">
      <div className="mx-auto flex max-w-3xl flex-col items-center gap-3 rounded-2xl border border-[var(--c-border)] bg-[var(--c-ink)] p-4 text-white shadow-2xl sm:flex-row">
